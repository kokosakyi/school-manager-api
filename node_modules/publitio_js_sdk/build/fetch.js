...
function (_Error) {
  ...
  function InvalidJSONError(responseData) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(InvalidJSONError).call(this, "The server was expected to respond with JSON, but didn't. This might be because you used " + "an invalid endpoint URL, an invalid HTTP method, or due to an internal server error. Response:\n" + responseData));
  }
